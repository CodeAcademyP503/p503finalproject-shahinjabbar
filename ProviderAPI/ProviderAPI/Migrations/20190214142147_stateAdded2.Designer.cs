...
namespace ProviderAPI.Migrations
{
    ...
    [Migration("20190214142147_stateAdded2")]
    partial class stateAdded2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProviderAPI.Models.State.StatePrefix", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ProviderAPI.Models.State.VN", b =>
                {
                    b.HasOne("ProviderAPI.Models.State.StatePrefix", "StatePrefix")
                        .WithMany()
                        .HasForeignKey("StatePrefixId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
